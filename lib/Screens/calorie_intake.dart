                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(left: 16,top: (28/640)*displayHeight(context),right: 11 ),
                      // color: Colors.red,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: calorie_intake_container_list.map((e){
                          var index = calorie_intake_container_list.indexOf(e);
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [BoxShadow(
                                color: kshadow_color,
                                blurRadius: e.isSlected?0:k_shadow_blur_radius,
                                spreadRadius: e.isSlected?0:k_shadow_spread_radius,
                              )],
                                color: e.isSlected?Color(0xffDFDCDC):Colors.white
                              ),
                              child: Column(
                                children: [
                                  SizedBox(height: (16/640)*displayHeight(context),),
                                  Container(
                                    height: (62/640)*displayHeight(context),
                                    width: (63/360)*displayWidth(context),
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(left: (16/360)*displayWidth(context),right: (16/360)*displayWidth(context),top: (37/640)*displayHeight(context)),
                      decoration: BoxDecoration(
                        color: Colors.white,
                    ...
                    Container(
                      ...
                      width: (328/360)*displayWidth(context),
                      margin: EdgeInsets.only(left: (16/360)*displayWidth(context),right: (16/360)*displayWidth(context),top: (19/640)*displayHeight(context)),
                      child: Row(
                        children: [
                          Container(
                            height: (42/640)*displayHeight(context),
                          ...
                          SizedBox(width: (40/360)*displayWidth(context),),
                          Container(
                            height: (42/640)*displayHeight(context),
                            width: (143/360)*displayWidth(context),
                            decoration: BoxDecoration(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        margin: EdgeInsets.only(top: (10/640)*displayHeight(context)),
                        decoration: BoxDecoration(
                    ...
                    Container(
                      height:(5/640)*displayHeight(context) ,
                        ...
                        padding: EdgeInsets.symmetric(horizontal: (32/360)*displayWidth(context)),
                        child: Divider(
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                        itemCount: meal==0?calorieIntakeItemlistBreakfast.length:meal==1?calorieIntakeItemlistLunch.length:calorieIntakeItemlistDinner.length,
                          itemBuilder: (context,index){
                            return CalorieIntakeItemlistTile(
                              text: '${meal==0?calorieIntakeItemlistBreakfast[index].text:meal==1?calorieIntakeItemlistLunch[index].text:calorieIntakeItemlistDinner[index].text}',
                              amount: meal==0?calorieIntakeItemlistBreakfast[index].amount:meal==1?calorieIntakeItemlistLunch[index].amount:calorieIntakeItemlistDinner[index].amount,
                              calories: meal==0?calorieIntakeItemlistBreakfast[index].calorie:meal==1?calorieIntakeItemlistLunch[index].calorie:calorieIntakeItemlistDinner[index].calorie,
                            );
                          }),
                    )
                  ],
...
List<CalorieIntakeItemList> calorieIntakeItemlistBreakfast = [];
  ...
  Future<void> gestureAction()async{
    if(meal==0){
      calorieIntakeItemlistBreakfast.add(CalorieIntakeItemList(text: meal_name,amount: amount,calorie: calories));
      int value= await AddCalorie(amount,calories.round(),'breakfast');
      await UpdateRow('breakfast', kformatedDate, value);
    }
    else if(meal == 1){
      calorieIntakeItemlistLunch.add(CalorieIntakeItemList(text: meal_name,amount: amount,calorie: calories)) ;
      int value= await AddCalorie(amount,calories.round(),'lunch');
      await UpdateRow('lunch', kformatedDate, value);
    }
    else if(meal == 2){
      calorieIntakeItemlistDinner.add(CalorieIntakeItemList(text: meal_name,amount: amount,calorie: calories));
