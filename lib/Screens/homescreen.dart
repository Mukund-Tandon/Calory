    ...
    return customAnimatedBottomBar(
      ...
      items: <BottomNavigationBarItem>[
        BottomNavigationBarItem(
          icon: Image.asset('assets/icons/fluent_home-28-regular.png',height: 28,color: Colors.black,),
          title: Text('Home'),
        ),BottomNavigationBarItem(
          icon: Image.asset('assets/icons/jam_write.png',height: 28,color: Colors.black,),
          title: Text('Entry'),
        // ),BottomNavigationBarItem(
