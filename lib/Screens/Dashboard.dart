...
var formatedDate= "${DateTime.now().day}-${DateTime.now().month}-${DateTime.now().year}";
...
Future<void> GetData()async{
  ...
  setState(() {
    print('done1');
    calorie_Intake_val = ((list[0])['breakfast']+(list[0])['lunch']+(list[0])['dinner']);
    print('done1');
                  ...
                  Stack(
                    children: [
                      ...
                      child: SizedBox(
                        height: 150,
                          width: 150,
                          child: meter(name: 'Calorie Intake',current_val: calorie_Intake_val ,max: calorie_intake_max,width_of_device: displayWidth(context),)),
                    ),
                      Positioned(
                        left: 10,
                        top: 5,
                  ...
                  Stack(
                    children: [
                      ...
                      child: SizedBox(
                        height: 150,
                          width: 150,
                          child: meter(name: 'Calorie Burned',current_val: calorie_burned_val ,max: calorie_burned_max,width_of_device: displayWidth(context),)),
                    ),
                      Positioned(
                        left: 10,
                        top: 5,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontFamily: 'Palaquin',
                                    fontSize: (13.4/640)*displayHeight(context),
                                    fontWeight: FontWeight.w300,
                                  ),
                                ),
                              ),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width:(30/411.4)*displayWidth(context) ,),
                                Container(
                                  width: 45,
                                  alignment: Alignment.center,
                                  child: FloatingActionButton(
