...
int selected_index;
double device_width ;
customAnimatedBottomBar({this.device_hieght=0,required this.items,required this.bottombaritem_selected,required this.selected_index, this.device_width=0});
  @override
...
class navItems extends StatelessWidget {
  ...
  double device_hieght;
  navItems({this.isSelected=false,required this.item,this.device_hieght=0});
